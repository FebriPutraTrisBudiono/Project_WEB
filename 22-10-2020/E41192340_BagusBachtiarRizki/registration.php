        ...
        <!-- End of Topbar -->
                ...
                <div class="card-body">
                    <form>
                       ...
                       <div class="form-group">
                          <input type="text" class="form-control form-control-user" id="subject" name="subject" placeholder="Username Anda" required>
                        </div>
                        <div class="form-group">
                       ...
                       <label for="agama">Pilih Agama Anda:</label>
                        <option value="Islam">Islam</option>islam
                        ...
                        <div>
                         <div class="form-group">
                         <input type="textbox" class="form-control form-control-user" id="textbox" name="textbox" placeholder="Text Box" required>
                       </div>

                       <button type="submit" class="btn btn-succes" name="submit">Tambah</button>
                       <?php
                       $name = @$_GET['name'];
