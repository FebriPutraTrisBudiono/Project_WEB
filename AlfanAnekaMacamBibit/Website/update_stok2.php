...
$tablebarangquery = $koneksi->query($tablebarang);
$tablebarangrow = $tablebarangquery->num_rows;

$tablehistory = "SELECT * FROM history";
$tablehistoryquery = $koneksi->query($tablehistory);
...
<body>
    ...
    <!-- End Main Top -->
        ...
        <section class="content">
            <a href="tab-barang.php">Nama Barang</a>
            <a href="tab-stok-barang.php">Stok Barang</a>
            <a href="tab-history.php">History</a>
            <div class="container">
