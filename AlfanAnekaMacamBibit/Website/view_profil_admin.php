...
<head>
 ...
 <meta charset="utf-8">
    ...
    <link rel="stylesheet" type="text/css" href="css/form_foto.css">
</head>
<body>
<!-- Start Main Top -->
                ...
                <div class="row z-depth-3"  style="box-shadow: 0 4px 10px 0 rgba(0,0,0,0.5)">
                    ...
                    <div class="col-sm-8 bg-white rounded-right">
                        <div class="row">
                            ...
                            <div class="col">
                                <a href="edit_profil_admin.php" class="contact100-form-btn submit btn btn-primary btn-lg btn-block" style="color: white;">Edit</a>
                            </div>
                            <div class="w-100"></div>
                            <div class="col">
                                <br>
