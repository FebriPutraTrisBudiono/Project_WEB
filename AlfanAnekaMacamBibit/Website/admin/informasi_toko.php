<?php 
    ...
    if(isset($_POST["ubah"])){
        header("location:informasi_toko-edit.php");
    }
	?>
                            ...
                            <div class="card-body">
                                <div class="d-sm-flex justify-content-between align-items-center">
                                   ...
                                   <form method="post" enctype="multipart/form-data">
                                      <div class="mb-3">
                                        <h6>About Us</h6>
                                        <label><?php echo $data['about_us']; ?></label>
                                      </div>
                                      <div class="mb-3">
                                        <h6>Nama Facebook</h6>
                                        <label><?php echo $data['nama_facebook']; ?></label>
                                      </div>
                                      <div class="mb-3">
                                        <h6>Nomor Whatsapp</h6>
                                        <label><?php echo $data['whatsapp']; ?></label>
                                      </div>
                                      <div class="mb-3">
                                        <h6>Jam Kerja</h6>
                                        <label><?php echo $data['business_time']; ?></label>
                                      </div>
                                      <div class="mb-3">
                                        <h6>Logo Atas</h6>
                                        <img src="../logo/<?php echo $data['logo_atas']?>" class="logo" alt="">
                                      </div>
                                      <div class="mb-3">
                                        <h6>Logo Bawah</h6>
                                        <img src="../logo/<?php echo $data['logo_bawah']?>" class="logo" alt="" style="background-color: grey;">
                                      </div>
                                      <div class="mb-3">
                                        <h6>Highlight 1</h6>
                                        <label><?php echo $data['highlight1']; ?></label>
                                      </div>
                                      <div class="mb-3">
                                        <h6>Highlight 2</h6>
                                        <label><?php echo $data['highlight2']; ?></label>
                                      </div>
                                      <div class="mb-3">
                                        <h6>Highlight 3</h6>
                                        <label><?php echo $data['highlight3']; ?></label>
                                      </div>
                                      <div class="mb-3">
                                        <h6>Highlight 4</h6>
                                        <label><?php echo $data['highlight4']; ?></label>
                                      </div>
                                      <div class="mb-3">
                                        <h6>Highlight 5</h6>
                                        <label><?php echo $data['highlight5']; ?></label>
                                      </div>
                                      <div class="mb-3">
                                        <h6>Highlight 6</h6>
                                        <label><?php echo $data['highlight6']; ?></label>
                                      </div>
                                      <div class="mb-3">
                                        <h6>Highlight 7</h6>
