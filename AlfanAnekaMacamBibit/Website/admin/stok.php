                                ...
                                <div class="d-sm-flex justify-content-between align-items-center">
                                    ...
                                    <div class="data-tables datatable-dark">
										 <table id="dataTable3" class="display" style="width:100%"><thead class="thead-dark">
											...
											<?php 
											$brgs=mysqli_query($koneksi,"SELECT * from barang");
											$no=1;
											while($p=mysqli_fetch_array($brgs)){
												...
												<tr>
													<td><?php echo $no++ ?></td>
													<td><img src="../foto_brg/<?php echo $p['foto_barang'] ?>" width="100px"\></td>
													<td><?php echo $p['nama_barang'] ?></td>
													<td><?php echo $p['jenis_barang'] ?></td>
													<td><?php echo $p['stok_barang'] ?></td>
													<?php echo "<td><a class='edit'href='stok-edit-tambah.php?id=" .$p['idbarang']. "'>Tambah Stok</a></td>"; ?>
													<?php echo "<td><a class='edit'href='stok-edit-kurangi.php?id=" .$p['idbarang']. "'>Kurangi Stok</a></td>"; ?>
