                                ...
                                <div class="d-sm-flex justify-content-between align-items-center">
                                    ...
                                    <div class="data-tables datatable-dark">
                                         <table id="dataTable3" class="display" style="width:100%"><thead class="thead-dark">
                                            ...
                                            <?php 
                                            $brgs=mysqli_query($koneksi,"SELECT * from cart c, pengguna l where c.username=l.username and status!='Cart' and status!='Selesai' order by idcart ASC");
                                            $no=1;
                                            ...
                                            $orderids = $p['orderid'];
                                                ...
                                                if($cekrow > 0){
                                                    ...
                                                    //echo $p['status'] 
                                                    $orders = $p['orderid'];
                                                    $cekkonfirmasipembayaran = mysqli_query($koneksi,"SELECT * from cart where orderid='$orders'");
