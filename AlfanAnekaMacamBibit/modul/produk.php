<?php 
	$page = $_GET['page'];
	$sqlbrg = $koneksi->query("SELECT*FROM tbkategori WHERE kdkat='$page'");
...
<div class="wrap">	
	<div class="main">
		...
		<!-- start grids_of_3 -->
			<?php 
					$sqlk = $koneksi->query("SELECT*FROM tbkategori WHERE kdkat='$idkt'");
					while ($vk = $sqlk->fetch_array()) {
						$idk = $vk['kdkat'];
						?>
		<div class="grids_of_3">
			<?php 
					$sqlm = $koneksi->query("SELECT*FROM tbbarang WHERE kdkat='$idk'");
